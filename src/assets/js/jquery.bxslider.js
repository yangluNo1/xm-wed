; (function($) {
    ...
    $.fn.bxSlider = function(options) {
        ...
        var appendControls = function() {
            // slider.controls.next = $('<a class="pinpaiLarrow" href="">123</a>');
            // slider.controls.prev = $('<a class="pinpaiRarrow" href="">123</a>');
            $(".pinpaiLarrow").bind('click', clickNextBind);
            $(".pinpaiRarrow").bind('click', clickPrevBind);
            ...
            if (!slider.settings.nextSelector && !slider.settings.prevSelector) {
                ...
                slider.controls.el.append(slider.controls.directionEl);
            }
        }
        var appendControlsAuto = function() {
            ...
            if (slider.settings.autoControlsSelector) {
                ...
                slider.controls.el.append(slider.controls.autoEl);
            }
