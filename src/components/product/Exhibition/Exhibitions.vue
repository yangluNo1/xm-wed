  ...
  <div class="Exhibitions">
    ...
    <div class="jianjie">
      ...
      <div class="dianpujieshao">
        <ul>
          <li><strong>{{dianpus.stopname}}</strong></li>
          <li>
            <div class="dianpujieshao-rzbox clearfix">
              <dl class="dianpujieshao-tongji ">
                <dd class="renqi">
                  人气{{dianpus.renqi}}w </dd>
                <dd class="pinglun">
                  评论{{dianpus.pinglun}} </dd>
                <dd class="zuopin">
                  作品{{dianpus.zuopin}} </dd>
              </dl>
            </div>
          </li>
          <li>
            <p class="dianpujieshao-address clearfix">
              <span class="titfl">地址</span>
              <span class="addpr">{{dianpus.dizhi}}</span>
              <a href="javascript:;" class="mdialog" data-url="" data-width="750" data-height="320"
                title="还在抄写地址电话吗？点一下，短信免费发给您">
                <i class="sendphone"></i>
                <span class="fasong">发送到手机</span>
              </a>
            </p>
          </li>
          <li>
            <p class="dianpujieshao-logotxt clearfix">
              <span class="titfl">
                电话
              </span>
              <span>
      ...
      <el-dropdown>
        ...
        <el-dropdown-menu slot="dropdown" class="bdsharebuttonbox">
          ...
          <el-dropdown-item><a href="#" class="bds_qzone" data-cmd="qzone"><i class="qq1"></i>QQ空间</a>
          </el-dropdown-item>
          <el-dropdown-item><a href="#" class="bds_weixin" data-cmd="weixin"><i class="wx1"></i>微信朋友圈</a>
          </el-dropdown-item>
        </el-dropdown-menu>
    ...
    <div class="exposition">
      位置: <router-link to="/">首页</router-link>&gt;<router-link :to="this.$route.path">{{commonTitle}}</router-link>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        dianpus: {
          id: 1,
          stopname: "厦门大提大作婚纱摄影工作室",
          renqi: 123,
          pinglun: 1201,
          zuopin: 142,
          dizhi: "[思明区] 滨海街道黄厝溪头下71号",
          phone: 1888888888,
          touxiang: require("../../../assets/5.jpg")
        },
        commonTitle: "",
        txss: ""
      }
    ...
    created() {
      ...
      switch (routePath) {
        ...
        case '/jingpinzhekou':
          ...
          break;
        case '/zuopinjingxuan':
          this.commonTitle = '作品精选';
          break;
        case '/youhuihuodong':
          this.commonTitle = '优惠活动';
          break;
        case '/gongsijianjie':
          this.commonTitle = '公司简介';
          break;
...
<style scoped="">
  ...
  .kf2 {
    ...
    height: 16px;
    margin-right: 5px;
    background: url(../../../assets/kf2.gif) no-repeat;
  ...
  /* .dianpujieshao-address i:hover{
        background: url(../../../assets/pub_shopbasic_icon.png) no-repeat scroll 0 -181px transparent;
  width: 15px;
    height: 15px;
    margin-top: 3px;
    margin-right: 5px;
    ...
    -webkit-transition: all .1s ease-in,ease-out .2s;
} */
  .dianpujieshao-address i {
    background: url(../../../assets/pub_shopbasic_icon.png) no-repeat scroll 0 -181px transparent;
    width: 15px;
    height: 15px;
    margin-top: 3px;
  ...
  .dianpujieshao-address .addpr,
  .dianpujieshao-logotxt span {
    overflow: hidden;
  ...
  .dianpujieshao-address,
  .dianpujieshao-logotxt {
    color: #666;
    float: left;
  }
